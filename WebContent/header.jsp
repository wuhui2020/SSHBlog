...
<div id="top_bar" class="container hidden-xs hidden-sm">
    <div class="row">
        ...
        <div class="col-md-offset-3">
            <span class="top-bar-right pull-right"></span>
        </div>
    </div>
</div>
<!--导航-->
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <a class="navbar-brand" href="index.html" style="margin-left: 180px">
                <img src="images/lk_logo_sm.jpg" alt="ww" style="width:130px;height:60px">
            </a>
...
<script>
	$(function(){
		...
		$.ajax({
			type:"post",
			url:"${ctx}/web_getcategory.action",
			dataType:"json",
			data:{"parentid":"0"},
			success:function(data){
				$.each(data,function(i,obj){
					$("#nav").append("<li class='active' cid='"+obj.cid+"' parentid='"+obj.parentid+"'><a href='index.jsp?cid="+obj.cid+"'>"+obj.cname+"</a></li>")
				})
